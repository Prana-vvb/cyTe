...
def disp(msg, mat, n: int):
    ...
    while i < len(msg):
        ...
        if loc[1] == loc1[1]:
            res += "{}{}".format(mat[(loc[0] + n) % 5][loc[1]],
                                 mat[(loc1[0] + n) % 5][loc1[1]]).lower()
        elif loc[0] == loc1[0]:
            res += "{}{}".format(mat[loc[0]][(loc[1] + n) %
                                 5], mat[loc1[0]][(loc1[1] + n) % 5]).lower()
        else:
            res += "{}{}".format(mat[loc[0]][loc1[1]],
                                 mat[loc1[0]][loc[1]]).lower()
